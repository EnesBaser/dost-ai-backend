...
def build_system_prompt(user, profile, learned_facts, emotion_history,
    ...
    return (
        ...
        "- Türkiye tarihi, coğrafya, bilim, kültür, siyasi tarih gibi konularda kendi bilginle cevap ver — web araması gerekmez\n"
        "- 'Bilgi bulamadım' veya 'güncel bilgiye ulaşamam' deme; bunun yerine bildiklerini paylaş\n"
        "- Listeler, kronoloji, biyografi gibi sorularda eksiksiz ve doğru cevap ver\n"
        "- Sadece gerçek zamanlı veri gerektiren sorularda (anlık fiyat, bugünkü haber) kısıtlamandan bahset\n"
